...
The <b>OCCSVG.NET package</b> is built upon several key technologies: .Net, C#, C++/CLI. It also uses <b>Occt.NET</b> (version 7.9.0), which is based on <b>Open CASCADE Technology (OCCT)</b>, is available from: 
